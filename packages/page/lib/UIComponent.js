...
var UIComponent = (_dec = (0, _reactKeydown.default)('backspace'), (_class =
/*#__PURE__*/
function (_React$Component) {
  ...
  _createClass(UIComponent, [{
    ...
    value: function renderComponent() {
      var node = this.props.node; // if (node.type === 'card') {
      //   return (
      ...
      if (node.type === 'coder') {
        return _react.default.createElement(_Coder.default, this.props);
      } else if (node.type === 'textbox') {
        return _react.default.createElement(_Textbox.default, this.props);
      } else if (node.type === 'test') {
        return _react.default.createElement("div", null, "555", _react.default.createElement("input", {
          type: "radio",
          name: "aaa",
          value: 3
        ...
        return _react.default.createElement(_CodeBlock.default, this.props);
      }
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement(_reactRnd.Rnd, _extends({}, this.props.attributes, {
        ...
        onClick: function onClick(e) {
          ...
          _this2.props.editor.change(function (change) {
