  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_antd.Card, {
        ...
        title: _react.default.createElement(_reactContenteditable.default, {
          onChange: function onChange(e) {
            return instance.setProp('title', e.target.value);
          },
          html: instance.props.get('title')
        })
      }, _react.default.createElement(_reactContenteditable.default, {
        onChange: function onChange(e) {
          return instance.setProp('content', e.target.value);
        },
